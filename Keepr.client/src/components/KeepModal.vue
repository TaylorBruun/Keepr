            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6 fill flex-grow-1">
                            <div class="row">
                                <div class="col d-flex flex-column ">
                                    ...
                                    <div class="row p-0 pb-1 border-0 modal-header">
                                        <div class="col-4">
                                            <h6 class="activity-icon"><i class="mdi mdi-key-star"></i> {{ keep.kept }}
                                            </h6>
                                        </div>
                                        <!-- NOTE v-if false means it will never show. Enable if shares gets implemented -->
                                    ...
                                    <div class="">
                                        <h6 class="text-muted b0"><em>
                                                {{ keep.description }}
                                            </em></h6>
                                    </div>


                                    <div class="row position-absolute bottom-0 d-flex align-items-center mt-5 pt-5 pb-3">
                                        <!-- add to vault -->
                                        <div class=" col-5 me-5 m-2">
                                            <div class="btn-group dropup">
                                                <button v-if="account.id" type="button"
                                                    class="btn drop-btn  dropdown-toggle" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    Add to Vault
                                                </button>
                                        ...
                                        <div v-if="keep.creatorId == account.id" @click.stop="deleteKeep"
                                            ...
                                            <i title="Delete" class="delete-icon mdi mdi-delete"></i>
                                        </div>
                                    </div>
